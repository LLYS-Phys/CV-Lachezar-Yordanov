function navigmenu() {
  ...
  function readmore() {
    var readmore = document.getElementById("learnmore");
  ...
  function readmore2() {
    var readmore2 = document.getElementById("learnmore2");
  ...
  function readmore3() {
    var readmore3 = document.getElementById("learnmore3");
  ...
  function readmore4() {
    var readmore4 = document.getElementById("learnmore4");
  ...
  function readmore5() {
    var readmore5 = document.getElementById("learnmore5");
    var moreText5 = document.getElementById("more5");
    var btnText5 = document.getElementById("myBtn5");
  
    if (readmore5.style.display === "none") {
